...
/// TestMessage is an instuction set used in testing. The [`Forwarder`] and other machines implement it.
...
/// ChaosMonkeyMutation is an enum used by the TestMessage instruction set.
...
/// TestStruct is a struct used by the TestMessage instruction set.
